...
The guide covers the complete flow through Free Network selection, agent assignment, origin configuration, review, and tunnel creation. After creation, the installer checks Playit every five seconds and prints the public endpoint when allocation finishes.
